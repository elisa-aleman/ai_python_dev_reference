...
RUN wget https://github.com/Kitware/CMake/releases/download/v3.30.3/cmake-3.30.3-linuxx86_64.tar.gz && \
    tar -zxvf cmake-3.30.3-linuxx86_64.tar.gz && \
    rm cmake-3.30.3-linuxx86_64.tar.gz && \
    mv cmake-* cmake
